...
File:close()
bot.sendDocument(R,0,'./'..bot_id..'.json', '🇸🇦︙تم جلب النسخه الاحتياطية', 'md')
end
...
srt = "messageText"
elseif TextMsg == 'الدردشه' or TextMsg == 'الدردشه بالكتم' or TextMsg == 'الدردشه بالطرد' or TextMsg == 'الدردشه بالتقييد' or TextMsg == 'الدردشه بالتقييد' then
srt = "message"
